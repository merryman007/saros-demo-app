  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-white mb-2">DLMM</h1>
          <p className="text-gray-400">
            Our DLMM can help you earn more with dynamic fees, concentrated liquidity, and customizable strategies
          </p>
